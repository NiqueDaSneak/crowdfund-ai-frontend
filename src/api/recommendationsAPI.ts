...
const fakeRecommendations: {
  [key: string]: { [key: string]: Recommendation[] };
} = {
  'project-overview': {
    A: [],
    'A-': [
      {
        text: 'Consider minor adjustments to your project summary.',
        met: true,
      },
    ...
    'C+': [
      {
        text: 'Enhance your project summary with specific details.',
        met: false,
      },
    ...
    'C-': [
      {
        text: 'The project overview needs significant improvements.',
        met: false,
      },
  ...
  'campaign-story': {
    ...
    'C-': [
      {
        text: 'Your campaign story needs significant improvement.',
        met: false,
      },
  ...
  'budget-and-funding': {
    ...
    'C-': [
      {
        text: 'Significant improvements needed for budget details.',
        met: false,
      },
    ...
    'D-': [
      ...
      { text: 'Ensure the budget is clear and detailed.', met: false },
      {
        text: 'Provide detailed explanations for each budget item.',
        met: false,
      },
    ],
    F: [
  ...
  'risks-and-challenges': {
    ...
    'C-': [
      ...
      {
        text: 'Include a clear and detailed risk management plan.',
        met: false,
      },
    ...
    F: [
      {
        text: 'Completely revamp your risks and challenges section.',
        met: false,
      },
...
export const getRecommendations = async (
  ...
  console.log(
    `Fetching recommendations for section: ${section}, grade: ${grade}`,
  );
...
export const processContent = async (
  ...
  try {
    const response = await axios.post(
      'https://thisisdom4.pythonanywhere.com/process',
      {
        dataType,
        dataBody,
        categories,
